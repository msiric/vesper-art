    ...
    <Card>
              ...
              items: [
                {
                  ...
                  component: (
                    <PricingCard
                      ...
                      isSeller={isSeller}
                      isAvailable
                      heading="Simulated personal license. Creates a demo receipt only; grants no usage rights."
                      license="personal"
                ...
                },
                {
                  ...
                  component: (
                    <PricingCard
                      ...
                      isSeller={isSeller}
                      isAvailable
                      heading="Simulated commercial license. No payment is collected and no usage rights are granted."
                      license="commercial"
                      loading={artworkLoading}
                      handlePurchase={({ versionId, license }) =>
                        purchaseArtwork({ history, versionId, license })
      ...
      >
        ...
        <FormProvider control={control}>
          ...
          >
            <p style={{color:"#ffd49d"}}>Simulation only. This creates a demo receipt and grants no real usage rights.</p>
            <LicenseForm
              getValues={getValues}
