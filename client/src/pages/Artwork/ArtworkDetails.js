...
const ArtworkDetails = ({ match, location, socket }) => {
  ...
  const {
    data: fetchArtworkDetailsResponse,
    status: fetchArtworkDetailsStatus,
  } = useQuery(
    [
      "fetchArtworkDetails",
      {
    ...
    getDetails.request,
    {
      onSuccess: (response, values) =>
        handleFetchSuccess(response.data.artwork),
    }
  );
  ...
  const isLoading = () => fetchArtworkDetailsStatus === "loading";
